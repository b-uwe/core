...
2. I expect claude to ALWAYS ruff, mypy and lint its code! Also for test code!
3. After each new feature implementation new tests are supposed to be created ALWAYS, so that coverage stays above 95%
4. After each new feature implementation check README.md and propose changes!